...
public class DocumentServiceTests
{
    ...
    public DocumentServiceTests()
    {
        ...
        _service = new DocumentService(_repositoryMock.Object, _outboxRepositoryMock.Object, _fileStorageMock.Object, loggerMock.Object);
    }
    ...
    public async Task CreateDocumentAsync_SavesFileAndCreatesOutbox()
    {
        ...
        _outboxRepositoryMock.Setup(x => x.CreateAsync(It.IsAny<DocumentDto>(), It.IsAny<OutboxMessage>(), It.IsAny<CancellationToken>()))
        ...
        _outboxRepositoryMock.Verify(x => x.CreateAsync(It.IsAny<DocumentDto>(), It.IsAny<OutboxMessage>(), It.IsAny<CancellationToken>()), Times.Once);
    }
